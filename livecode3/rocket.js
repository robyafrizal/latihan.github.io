...
// Write code here
 function infoAgustus (arr) {
   var day = ["Kamis", "Jumat", "Sabtu", "Minggu", "Senin", "Selasa", "Rabu"];
   
   for(var i = 0; i <= arr; i++) {
      if(i == 0) {
        var dayRow = String(day[0]) + " " + String(day[1]) + " " + String(day[2]) + " " + String(day[3]) + " " + String(day[4]) + " " + String(day[5]) + " " + String(day[6]);
      } else {
        day[0] = day[0];
        day[1] = day[1];
        day[2] = day[2];
